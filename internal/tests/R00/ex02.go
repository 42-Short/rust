...
func yes() Exercise.Result {
	exercise := Exercise.NewExercise("02", "studentcode", "ex02", []string{"yes.rs"}, nil, -1, nil)
...
func collatz() Exercise.Result {
	exercise := Exercise.NewExercise("02", "studentcode", "ex02", []string{"collatz.rs"},  nil, -1, nil)
	exercise.TurnInFiles = testutils.FullTurnInFilesPath(exercise)
...
func printBytes() Exercise.Result {
	exercise := Exercise.NewExercise("02", "studentcode", "ex02", []string{"print_bytes.rs"}, nil, -1, nil)
	exercise.TurnInFiles = testutils.FullTurnInFilesPath(exercise)
...
func ex02() Exercise.Exercise {
	return Exercise.NewExercise("02", "studentcode", "ex02", []string{"collatz.rs", "print_bytes.rs", "yes.rs"}, nil, 20, ex02Test)
}
